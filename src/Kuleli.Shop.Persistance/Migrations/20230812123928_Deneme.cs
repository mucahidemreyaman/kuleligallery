        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ID = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    CITY_NAME = table.Column<string>(type: "nvarchar(20)", nullable: false),
                    IS_DELETED = table.Column<bool>(type: "bit", nullable: true, defaultValueSql: "0")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ID = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    CUTOMER_ID = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "ORDER_DETAILS_ORDER_ORDER_ID",
                        column: x => x.ORDER_ID,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ORDERS_CUTOMER_ID",
                table: "ORDERS",
                column: "CUTOMER_ID");

            migrationBuilder.CreateIndex(
                name: "IX_PRODUCT_COMMENTS_CUSTOMER_ID",
